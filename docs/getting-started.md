...
**Note:** The Ruby gem sends events to a local Go agent process, which then forwards them to your main Rails application. This provides better performance and reliability.
